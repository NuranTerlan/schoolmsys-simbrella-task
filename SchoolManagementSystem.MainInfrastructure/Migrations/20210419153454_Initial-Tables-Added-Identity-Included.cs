...
{
    public partial class InitialTablesAddedIdentityIncluded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AveragePerformanceForYear = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndividualRoom = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    CountOfExperienceYears = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "Address", "BirthYear", "ConcurrencyStamp", "CreatedOn", "Email", "EmailConfirmed", "FirstName", "Gender", "LastModifiedOn", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "8691d119-f241-474a-bf88-3941618e5caf", 0, "Sumqayit", (short)2002, "8691d119-f241-474a-bf88-3941618e5caf", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "devvhale@gmail.com", true, "Nuran", 0, null, "Terlan", false, null, "DEVVHALE@GMAIL.COM", "DEVVHALE", "AQAAAAEAACcQAAAAEOrztoNl4q2OY7u9AcQtM09w0Z+Cmj3/kt6Th6li1MqGkhLWZ41jAO5GMfKE8t3IIQ==", null, true, "5a213b7d-720f-42ac-b8e1-b8cde7c8cb80", false, "devvhale" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "a1bb5179-59a8-471e-a29a-90065b471062", "8691d119-f241-474a-bf88-3941618e5caf" });
